"""
3D Frame Rotation Animation

Demonstrates visualization of a 3D frame (three basis vectors) rotating
around a diagonal axis. The frame is displayed as three arrows from
the origin, one for each spanning vector.

Run: uv run python -m morphis.examples.animate_3d
"""
