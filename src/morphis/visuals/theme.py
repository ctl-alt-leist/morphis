...
# =============================================================================
# All sizes use 16:10 aspect ratio (common for displays).

SMALL: tuple[int, int] = (800, 500)
MEDIUM: tuple[int, int] = (1280, 800)
LARGE: tuple[int, int] = (1920, 1200)

DEFAULT_SIZE: tuple[int, int] = MEDIUM
