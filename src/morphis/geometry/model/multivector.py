...
class MultiVector(GAModel):
    ...
    def __xor__(self, other: Blade | MultiVector) -> MultiVector:
        ...
        if isinstance(other, Blade):
            from morphis.geometry.algebra.operations import wedge_mv_bl

            return wedge_mv_bl(self, other)
        elif isinstance(other, MultiVector):
            from morphis.geometry.algebra.operations import wedge_mv_mv
    ...
    def __lshift__(self, other: Blade) -> MultiVector:
        """
        Left interior product (left contraction): M << v = M ⌋ v
    ...
    def __rshift__(self, other: Blade) -> MultiVector:
        """
        Right interior product (right contraction): M >> v = M ⌊ v
