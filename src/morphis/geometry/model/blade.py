...
class Blade(GAModel):
    ...
    def __xor__(self, other: Blade | MultiVector) -> Blade | MultiVector:
        ...
        if isinstance(other, Blade):
            from morphis.geometry.algebra.operations import wedge

            return wedge(self, other)
        elif isinstance(other, MultiVector):
            from morphis.geometry.algebra.operations import wedge_bl_mv
    ...
    def __lshift__(self, other: Blade) -> Blade:
        ...
        """
        if isinstance(other, Blade):
            from morphis.geometry.algebra.operations import interior_left
    ...
    def __rshift__(self, other: Blade) -> Blade:
        ...
        """
        if isinstance(other, Blade):
            from morphis.geometry.algebra.operations import interior_right
    ...
    def __invert__(self) -> Blade:
        ...
        """
        from morphis.geometry.algebra.geometric import reverse
    ...
    def __pow__(self, exponent: int) -> Blade:
        ...
        """
        if exponent == -1:
            from morphis.geometry.algebra.geometric import inverse
    ...
    def transform_by(self, M: MultiVector) -> None:
        ...
        """
        from morphis.geometry.transforms.actions import transform
    ...
    def normalize(self) -> Blade:
        ...
        """
        from morphis.geometry.algebra.norms import normalize
    ...
    def spanning_vectors(self) -> tuple[Blade, ...]:
        ...
        """
        from morphis.geometry.constructors.factorization import spanning_vectors
