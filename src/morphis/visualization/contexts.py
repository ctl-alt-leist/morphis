...
def render_pga_line(
    ...
    # For visualization, find a point on the line using moment × direction
    moment = zeros(3)
    if dim >= 4:
    ...
    # Point on line: p = moment × direction (approximately)
...
def render_pga_plane(
    ...
    # For 3D PGA (dim=4):
    # H^{123} gives the weight
    # H^{0kl} gives normal direction
