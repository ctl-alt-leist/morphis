...
class TestForwardSignature:
    ...
    def test_scalar_to_scalar(self):
        ...
        input_spec = BladeSpec(grade=0, collection_dims=1, dim=3)
        output_spec = BladeSpec(grade=0, collection_dims=1, dim=3)
    ...
    def test_bivector_to_scalar(self):
        ...
        input_spec = BladeSpec(grade=2, collection_dims=1, dim=3)
        output_spec = BladeSpec(grade=0, collection_dims=1, dim=3)
    ...
    def test_no_collection_dims(self):
        """Test pattern without collection dimensions."""
        input_spec = BladeSpec(grade=1, collection_dims=0, dim=3)
        output_spec = BladeSpec(grade=2, collection_dims=0, dim=3)
    ...
    def test_multiple_collection_dims(self):
        """Test pattern with multiple collection dimensions."""
        input_spec = BladeSpec(grade=0, collection_dims=2, dim=3)
        output_spec = BladeSpec(grade=1, collection_dims=2, dim=3)
